...
.dark {
  ...
  --app-accent:        #3b82f6;
  --app-accent-sub:    rgba(59, 130, 246, 0.12);
  --app-accent-border: rgba(59, 130, 246, 0.28);
...
| `--app-accent` | `#2f55d4` | `#3b82f6` | Primary action color (buttons, active nav) |
| `--app-accent-sub` | `rgba(47,85,212,0.09)` | `rgba(59,130,246,0.12)` | Accent backgrounds, active nav bg |
| `--app-accent-border` | `rgba(47,85,212,0.22)` | `rgba(59,130,246,0.28)` | Accent-tinted borders |
| `--app-accent-text` | `#2f55d4` | `#60a5fa` | Accent text (lighter blue in dark mode) |
...
Eye, EyeOff, User, Lock, Key, KeyRound                       — auth / setup
