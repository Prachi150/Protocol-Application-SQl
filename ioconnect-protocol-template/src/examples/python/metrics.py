...
# prefix needs changing. Search for "opcua_" and replace it with your
...
class Metrics:
    ...
    def __init__(self):
        ...
        # ── Histograms ──
        # REPLACE: change all "opcua_" prefixes below to your protocol slug (e.g. "modbus_", "s7_", "myproto_")
        self.latency_family = Histogram(
            'opcua_poll_latency_ms',
